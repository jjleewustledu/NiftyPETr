#!/bin/csh
#$Header: /data/petsun4/data1/solaris/csh_scripts/RCS/cross_bold_pp_130702.csh,v 1.14 2016/08/12 00:06:04 avi Exp $
...
set idstr = '$Id: cross_bold_pp_130702.csh,v 1.14 2016/08/12 00:06:04 avi Exp $'
echo $idstr
...
##########################################
	...
	if ($status) exit $status
	if (-e ${patid}_func_vols_ave_to_${target:t}_t4) /bin/rm	${patid}_func_vols_ave_to_${target:t}_t4
