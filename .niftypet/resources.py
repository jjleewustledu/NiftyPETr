...
PATHTOOLS = '/ds/NiftyPET_tools'
RESPATH = '/ds/NiftyPET_tools/niftyreg/bin/reg_resample'
REGPATH = '/ds/NiftyPET_tools/niftyreg/bin/reg_aladin'
DCM2NIIX = '/ds/NiftyPET_tools/dcm2niix/bin/dcm2niix'
HMUDIR = '/ds/hardwareumaps'
### end NiftyPET tools ###
# -----------------------------------------------------
